...
fn get_centered_rect(rect_width: u32, rect_height: u32, cons_width: u32, cons_height: u32) -> Rect {
    ...
    let cx = (Controller::SCREEN_WIDTH as i32 - w) / 2;
    let cy = (Controller::SCREEN_HEIGHT as i32 - h) / 2;
    Rect::new(cx as i32, cy as i32, w as u32, h as u32)
}

pub fn gameover_loop(io: &mut Controller) {
    io.draw_background();
    ...
    let target = get_centered_rect(
        width,
        height,
        Controller::SCREEN_WIDTH - padding,
        Controller::SCREEN_HEIGHT - padding,
    );
